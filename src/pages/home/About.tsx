                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="animate-fade-in-left">
                        <h2 className=" py-3 text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                             Cơ sở lý luận CNH, HĐH ở Việt Nam
                        </h2>
                        <p className={`text-lg mb-4 leading-relaxed transition-colors duration-300 ${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>
                            ...
                            <br />
                            💠Ở Việt Nam, CNH, HĐH là chuyển đổi căn bản, toàn diện các hoạt động kinh tế - xã hội trên nền tảng công nghệ hiện đại.
                        </p>
                        <p className={`text-lg mb-6 leading-relaxed transition-colors duration-300 ${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>
                            💠CNH, HĐH là quy luật phổ biến của phát triển lực lượng sản xuất và là con đường xây dựng cơ sở vật chất - kỹ thuật cho CNXH ở nước ta.
                            <br />
                            💠Mỗi bước tiến CNH, HĐH đều góp phần nâng cao năng suất, tạo của cải vật chất và hoàn thiện quan hệ sản xuất.
