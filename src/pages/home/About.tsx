            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-right">
                        <img src="/bg-modernization-factory.svg" alt="Công nghiệp hóa và hiện đại hóa" className={`rounded-lg shadow-2xl transition-all duration-300 ${theme === "dark" ? "hover:shadow-blue-500/50" : "hover:shadow-blue-300/50"}`} />
                    </div>
                </div>
            </div>
        </section>
